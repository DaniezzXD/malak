...
def keluar():
    print "makasih sudah pakai tools saya ^_^"
    os.sys.exit()
def acak(x):
    w = 'mhkbpcP'
    d = ''
...
def user_id():
    ...
    print logo
    print 50* "─"
    print "Masukkan username , \ncontoh :www.facebook.com/100014926689370\nhanya masukkan (100014926689370) nya saja, tanpa tanda kurung"
